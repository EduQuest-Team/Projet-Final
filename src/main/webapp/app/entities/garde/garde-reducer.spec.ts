...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './garde.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GARDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GARDE actions', async () => {
      const expectedActions = [
        {
