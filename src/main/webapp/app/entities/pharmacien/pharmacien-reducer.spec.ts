...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHARMACIEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHARMACIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHARMACIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHARMACIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHARMACIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHARMACIEN actions', async () => {
      const expectedActions = [
        {
