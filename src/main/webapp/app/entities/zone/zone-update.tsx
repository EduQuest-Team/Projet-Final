...
export const ZoneUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...zoneEntity,
      ...values,
      ville: villes.find(it => it.id.toString() === values.ville.toString()),
    };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaAiApp.zone.home.createOrEditLabel" data-cy="ZoneCreateUpdateHeading">
            <Translate contentKey="pharmaAiApp.zone.home.createOrEditLabel">Create or edit a Zone</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('pharmaAiApp.zone.nom')} id="zone-nom" name="nom" data-cy="nom" type="text" />
              <ValidatedField id="zone-ville" name="ville" data-cy="ville" label={translate('pharmaAiApp.zone.ville')} type="select">
                <option value="" key="0" />
                {villes
