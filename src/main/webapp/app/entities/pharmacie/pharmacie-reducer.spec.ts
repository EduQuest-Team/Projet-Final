...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pharmacie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHARMACIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHARMACIE actions', async () => {
      const expectedActions = [
        {
