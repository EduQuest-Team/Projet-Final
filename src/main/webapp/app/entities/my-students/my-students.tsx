...
import { getEntities as getAcademicYearEntities } from '../historique/historique.reducer';
import { useNavigate } from 'react-router';
import { getEntities as getGroupEntities } from '../pharmacien/pharmacien.reducer';
...
const MyStudents = () => {
  ...
  const academicYearList = useAppSelector(state => state.historique.entities);
  const groupeList = useAppSelector(state => state.pharmacien.entities);
