...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHARMACIEGARDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHARMACIEGARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHARMACIEGARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHARMACIEGARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHARMACIEGARDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHARMACIEGARDE actions', async () => {
      const expectedActions = [
        {
