...
class VilleResourceIT {
    ...
    //         Ville ville = new Ville().nom(DEFAULT_NOM).image(DEFAULT_IMAGE);
    //         return ville;
    //     }
    ...
    //         Ville ville = new Ville().nom(UPDATED_NOM).image(UPDATED_IMAGE);
    //         return ville;
    //     }
    ...
    //         updatedVille.nom(UPDATED_NOM).image(UPDATED_IMAGE);
    ...
    //         partialUpdatedVille.nom(UPDATED_NOM).image(UPDATED_IMAGE);
